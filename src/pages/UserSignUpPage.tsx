...
//     });
//
//     const [userArray, setUserArray] = useState([]); // State to store user data array
//
//     const handleChange = (e) => {
//         const { name, value } = e.target;
//         setFormData({ ...formData, [name]: value });
...
//         }
//
//         // Add formData to userArray and clear form
//         setUserArray([...userArray, formData]);
//         console.log("User Array: ", [...userArray, formData]); // Log the updated array
//
//         // Clear the form
//         setFormData({
//             firstName: "",
